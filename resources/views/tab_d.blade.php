    ...
    <div class="wrapper">
        ...
        <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <b>
                    <div class="breadcrumb-title pe-3">PT. BARTUH TAB D</div>
                </b>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Penerimaan Luar
                            </li>
                        </ol>
                    </nav>
                </div>
            ...
            <form action="/luar/input" method="post">
		    {{ csrf_field() }}
            <div class="card">
                <div class="card-header py-3">
                  ...
                  <ul class="nav nav-tabs tab-transparent" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="/4" >TAB D</a>
                    </li>
                  </ul>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                                            ...
                                            <tbody>                                               
                                                <tr>
                                                    ...
                                                    <div class="input-group button-container">
                                                            ...
                                                            <input type="number" min="0" max="" value="0" name="qty"
                        ...
                        <div class="col-12 col-lg-4">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-success cart-qty-save">Simpan</button>
                            </div>
